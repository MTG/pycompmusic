...
onsParams = coll.namedtuple('onsParams', "frmHop frmLen pdSmooth wtol pkProm thresE maxLen binWidth wtolHistAv Nbins minLen")
...
TCparams = coll.namedtuple('TCparams', 'theta BPM binWidth wtolHistAv Nbins minBPM delta octTol smoothParam octCorrectParam' )
...
samaParams = coll.namedtuple('samaParams', 'pwtol numSeedPeaks numCandPerWindow srchWtolLow srchWtolHigh tolLow tolHigh thres decayCoeff theta ignoreTooClose backSearch alphaDP Nperiods maxRetry')
...
aksharaParams = coll.namedtuple('aksharaParams', 'pwtol numSeedPeaks numCandPerWindow srchWtolLow srchWtolHigh tolLow tolHigh thres decayCoeff theta ignoreTooClose backSearch alphaDP')
